...
const TaskWidget    = lazy(() => import('mfe_vue_tasks/TaskWidget').then(m => ({
  default: m.default ?? m
})))
const WeatherWidget = lazy(() => import('mfe_react_weather/WeatherWidget').then(m => ({
  default: m.default ?? m
})))
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span style={{ fontFamily: 'var(--mono)', fontSize: '11px', color: 'var(--hint)' }}>
          {sublabel}
        </span>
      </div>
      <div style={{ flex: 1, padding: '1.25rem' }}>
        <Suspense fallback={
          <div style={{ fontFamily: 'var(--mono)', fontSize: '12px', color: 'var(--hint)', textAlign: 'center', padding: '2rem 0' }}>
            loading {label}…
          </div>
        }>
          {children}
...
function VueTaskWrapper() {
  ...
  useEffect(() => {
    ...
    import('mfe_vue_tasks/TaskWidget').then(({ default: TaskWidget }) => {
...
export default function App() {
  return (
    <div className="app">
      ...
      {/* NAV */}
      <nav className="nav">
        <a href="#hero" className="nav-logo">EC</a>
        <a href="#experience" className="nav-link">Experience</a>
        <a href="#skills" className="nav-link">Skills</a>
        <a href="#mfe-demo" className="nav-link">MFE Demo</a>
      ...
      <div className="wrap">
        ...
        <section id="hero" className="hero-section">
          <div>
            ...
            <p className="hero-desc">
              7+ years at Oak Street Health crafting enterprise .NET APIs, Vue 3 frontends,
              and microfrontend architectures. Focused on cloud, system design, and AI integration
              on the path to Senior Engineer.
            </p>
            <div className="hero-links">
              <a href="#resume" className="btn btn-primary">View Resume</a>
              <a href="#mfe-demo" className="btn btn-outline">Live MFE Demo →</a>
            </div>
          </div>
          <div className="hero-card">
            <div className="hero-stat"><div className="stat-num">7+</div><div className="stat-label">Years at Oak Street Health</div></div>
            <div className="hero-stat"><div className="stat-num">88%</div><div className="stat-label">Doc signing increase (week 1)</div></div>
            <div className="hero-stat"><div className="stat-num">1K+</div><div className="stat-label">Users supported</div></div>
          </div>
        </section>
        ...
        <section id="experience" className="section">
          ...
          <div className="exp-list">
            {[
              {
                dates: 'Apr 2022 – Present', role: 'Software Engineer II', company: 'Oak Street Health',
                bullets: [
              ...
              {
                dates: 'Apr 2021 – Mar 2022', role: 'Software Engineer', company: 'Oak Street Health',
                bullets: [
              ...
              {
                dates: 'Jun 2019 – Mar 2021', role: 'Junior Application Developer', company: 'Oak Street Health',
                bullets: [
              ...
              {
                dates: 'Jun 2017 – May 2019', role: 'Computer Engineer', company: 'Oak Street Health',
                bullets: [
              ...
              <div key={i} className="exp-item">
                <div className="exp-meta"><div className="exp-dates">{job.dates}</div></div>
                <div>
            ...
            {[
              ...
              <div key={i} className="skill-group">
                ...
                <div className="skill-tags">
                  {group.tags.map((t, j) => (
                    <span key={j} className={`tag ${group.accent ? 'tag-accent' : ''}`}>{t}</span>
                  ))}
                </div>
              </div>
            ))}
        ...
        <section id="mfe-demo" className="section">
          <div className="section-header">
            ...
            <p className="section-desc">
              Three independent framework bundles — Vue 3, Angular-style Web Component, and React 18 —
              loaded at runtime via Module Federation. Each MFE lives in its own GitHub repo,
              deploys independently, and owns its state entirely.
            </p>
          </div>
          ...
          <div className="mfe-wrapper">
            ...
            <div className="mfe-panels">
              <MfePanel color="vue" label="Vue 3" sublabel="Composition API" mountId="vue-mfe">
                <VueTaskWrapper />
              </MfePanel>
        ...
        <section id="projects" className="section">
          ...
          <div className="projects-grid">
            {[
              {
                icon: '🎮', name: 'Gaming Stats Dashboard', status: 'building',
              ...
              {
                icon: '🔧', name: 'AI Home Maintenance Tracker', status: 'planned',
              ...
              {
                icon: '🎵', name: 'Smart Music Discovery', status: 'planned',
              ...
              {
                icon: '⚡', name: 'MFE Portfolio Shell', status: 'live',
              ...
              <div key={i} className={`project-card ${p.status === 'live' ? 'project-live' : ''}`}>
                <div className="project-icon">{p.icon}</div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
                  <div className="project-name">{p.name}</div>
                  <span className={`project-status status-${p.status}`}>
                    {p.status === 'building' ? 'In Progress' : p.status === 'planned' ? 'Planned' : 'Live'}
                  </span>
                </div>
          ...
          <div className="resume-card">
            ...
            <div className="resume-body">
              <div>
                ...
                {[
                  { title: 'Software Engineer II', dates: 'Apr 2022 – Present', company: 'Oak Street Health',
                  ...
                  { title: 'Software Engineer', dates: 'Apr 2021 – Mar 2022', company: 'Oak Street Health',
                  ...
                  { title: 'Junior Application Developer', dates: 'Jun 2019 – Mar 2021', company: 'Oak Street Health',
                    bullets: ['Windows services for automated healthcare workflows','Automated referral task flow via ASP.NET'] },
                  { title: 'Computer Engineer', dates: 'Jun 2017 – May 2019', company: 'Oak Street Health',
                ...
                <div className="res-section-title" style={{ marginTop: '1.5rem' }}>Education</div>
                <div className="res-edu-school">Illinois Institute of Technology</div>
                <div className="res-edu-degree">MS & BS in Software Development</div>
                ...
                {[
                  ...
                  <div key={i} className="res-skill-group">
                    ...
                    <div className="res-skill-tags">
                      {g.tags.map((t, j) => <span key={j} className="res-tag">{t}</span>)}
                    </div>
                  </div>
                ))}
              </div>
        ...
        <section id="contact" className="section">
          ...
          <div className="contact-grid">
            <div className="contact-block">
              ...
              <a href="mailto:erickcruz147@gmail.com" className="contact-val">erickcruz147@gmail.com</a>
            </div>
            <div className="contact-block">
              <div className="contact-label">Phone</div>
              <span className="contact-val">(773) 818-6161</span>
            </div>
            <div className="contact-block">
              <div className="contact-label">Location</div>
              <span className="contact-val">Chicago, IL</span>
            </div>
            <div className="contact-block">
              <div className="contact-label">Open To</div>
              <span className="contact-val">Senior Engineer roles</span>
            </div>
          </div>
        </section>
      ...
      <footer className="footer">
        ...
        <div className="footer-pills">
          {['Vue 3','React 18','Web Components','Module Federation','GitHub Pages'].map((t, i) => (
            <span key={i} className="footer-pill">{t}</span>
          ))}
        </div>
      </footer>
